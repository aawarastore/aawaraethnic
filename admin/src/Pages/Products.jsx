                ...
                <div className='w-full'>
                    <div className='px-3 pt-4'>
                        ...
                        <div className='w-full'>
                            {
                                Items.map(item => {
                                    return <div className='bg-white my-2 px-3 py-2 relative' key={item._id}>
                                        {/* {
                                            openPortal && <EditProduct/>
                                        } */}
                                        <div className='my-2'>
                                            Product ID: {item.PRODUCT_id}
                                        </div>
                                        <div   className='text-end w-full'>Edit</div>
                                        <div className=' flex  gap-8 w-full'>
                                            <div >
                                                <div className='w-[120px]'> <img className='w-full' src={item.Product_img_url} alt="" /></div>
                                            </div>
                                            <div>
