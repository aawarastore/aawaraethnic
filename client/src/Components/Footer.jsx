...
const Footer = () => {
  return (
    <>
      <div className='w-screen py-10 px-10 bg-gradient-to-br to-black from-[#0c0c0ce8] flex flex-wrap flex-col items-center  justify-center content-center  text-white' >
      <div className='subtextLines text-yellow-600  px-2 py-2 text-[20px]'><Link to={'/home'}><span className='QuoteLines'>A</span>awara <span className='QuoteLines'>E</span>thnic</Link></div>
        ...
        <div className='flex gap-4 ss:w-full  w-[85vw] flex-wrap justify-center ss:text-[15px] text-[12px] '>
      ...
      <div className='w-screen flex justify-center py-3 text-center bg-[#0c0c0cd7] text-white text-[11px] ss:text-[14px]'>Copyright 2024 © AawaraEthnic.com | All Rights Reserved </div>
    </>
  )
}
