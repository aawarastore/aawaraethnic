...
const Footer = () => {
  return (
    <>
      ...
      <div className='w-screen flex justify-center py-3 text-center tracking-[1px] bg-[#efefef] text-black text-[11px] ss:text-[14px]'>Copyright 2024 © AAWARA ETHNIC | All Rights Reserved </div>
    </>
  )
}
